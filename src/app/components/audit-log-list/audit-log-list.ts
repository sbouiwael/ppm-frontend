...
import { AuditLogDTO, AuditAction, AUDIT_ACTIONS, AUDIT_ENTITY_TYPES, PageResponse } from '../../models/audit-log';
...
export class AuditLogList implements OnInit, OnDestroy {
  ...
  actionBadgeClass(action: AuditAction): string {
    switch (action) {
      ...
      case 'ASSIGN':            return 'badge-primary';
      case 'UNASSIGN':          return 'badge-neutral';
      case 'DEPENDENCY_ADD':    return 'badge-primary';
      case 'DEPENDENCY_REMOVE': return 'badge-neutral';
  ...
  actionLabel(action: AuditAction): string {
    const labels: Record<AuditAction, string> = {
      ...
      STATUS_CHANGE: 'Status Change', ASSIGN: 'Assign', UNASSIGN: 'Unassign',
      DEPENDENCY_ADD: 'Dep Add', DEPENDENCY_REMOVE: 'Dep Remove',
    };
